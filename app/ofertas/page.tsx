...
export default function OfertasPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-[#F0F7FF] to-white pt-32 pb-24 px-6 sm:px-8">
      <div className="max-w-7xl mx-auto">
        <SectionTitle
          ...
          subtitle="Conheça as campanhas exclusivas e marcas em destaque no armazém DUM. Imagens oficiais para celebrar os melhores sabores e momentos da nossa terra."
        />
        ...
        <div className="space-y-12 mb-20">
          {realCampaignBanners.map((banner, index) => {
            ...
            return (
              <div
                key={banner.id}
                className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 md:p-10 shadow-sm hover:shadow-xl hover:border-[#22C55E]/40 transition-all duration-300"
              >
                <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 items-center ${isReversed ? 'lg:grid-flow-dense' : ''}`}>
                  <div className={`lg:col-span-7 ${isReversed ? 'lg:col-start-6' : ''}`}>
                    <div
                      ...
                      className="group relative w-full rounded-2xl overflow-hidden cursor-pointer shadow-md border border-slate-200 bg-slate-50 transition-all duration-500 hover:scale-[1.01]"
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div className="flex items-center gap-2 text-white text-xs font-bold bg-gradient-to-r from-[#0066FF] to-[#22C55E] px-4 py-2 rounded-full shadow-lg">
                  ...
                  <div className={`lg:col-span-5 flex flex-col justify-between ${isReversed ? 'lg:col-start-1' : ''}`}>
                    <div>
                      <div className="flex flex-wrap items-center gap-2.5 mb-4">
                        <span className="px-3.5 py-1 rounded-full bg-gradient-to-r from-[#0066FF] to-[#22C55E] text-white text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-sm">
                          <Tag className="w-3 h-3" />
                          {banner.brand}
                        </span>
                        <span className="px-3 py-1 rounded-full bg-gradient-to-r from-amber-400 to-orange-500 text-white text-[11px] font-bold flex items-center gap-1 border border-amber-300/50 shadow-sm">
        ...
        <div className="p-8 sm:p-12 rounded-3xl border border-slate-200 bg-gradient-to-br from-white via-[#F0F7FF] to-emerald-50 text-center max-w-4xl mx-auto shadow-sm">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#0066FF] to-[#22C55E] flex items-center justify-center text-white mx-auto mb-5 shadow-lg shadow-emerald-500/25">
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap items-center justify-between gap-4 w-full px-2 text-white">
              ...
              <Link
                ...
                onClick={() => setSelectedBanner(null)}
                className="px-5 py-2.5 rounded-full bg-gradient-to-r from-[#0066FF] to-[#22C55E] text-white text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 transition-all hover:scale-[1.03] shadow-lg"
              >
